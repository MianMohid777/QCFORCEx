...
<script>
	...
	var successMessage = '<c:if test="${not empty success}">${success}</c:if>';
	if (successMessage) {
		alert(successMessage);
	}

	// Check for failure message and show alert
	var failureMessage = '<c:if test="${not empty failure}">${failure}</c:if>';
	if (failureMessage) {
